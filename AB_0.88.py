...
def home():
    ...
    if request.method == 'POST':
        ...
        <body>
            ...
            function initializeGrid(actionType, promptSettings) {
                const {
                    ...
                    prompt_type,
                    fade_duration,
                    fade_opacity,  // Updated variable name
                    highlight_color,
        ...
        ''', grid_cols=grid_cols,
                                      fade_opacity=fade_opacity,  # Pass the corrected fade_opacity
                                      fade_duration=fade_duration,
                                      highlight_color=highlight_color,
            ...
            document.getElementById('action_type').addEventListener('change', function() {
                if (this.value === 'click_and_drag') {
                    document.querySelectorAll('input[name="visible_target"]').forEach(function(checkbox) {
                        ...
                        checkbox.parentElement.style.display = 'inline-block';  // Ensure visibility
                    });
